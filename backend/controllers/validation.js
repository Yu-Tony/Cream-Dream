...
var result = false;
  ...
  module.exports = {
    ...
    ValidateCuenta: function (variable) {
        ...
        if( 
            validator.isNumeric(variable.propina  ? variable.propina.toString() : '') &&
            validator.isNumeric(variable.total  ? variable.total.toString() : '') &&
            (validator.equals(variable.metodo, "paypal")||validator.equals(variable.metodo, "efectivo"))
        )
        {
    ...
    ValidatePromo: function (variable) {
        ...
        if( 
            validator.isNumeric(variable.porcentaje  ? variable.porcentaje.toString() : '') &&
    ...
    ValidateResena: function (variable) {
        ...
        if( 
            validator.isNumeric(variable.calificacion  ? variable.calificacion.toString() : '') &&
            (validator.equals(variable.onModel, "empleado")||validator.equals(variable.onModel, "sucursal"))
        )
        {
            result = true;
            return result;
    ...
    ValidateReservacion: function (variable) {
        ...
        //Solo las opciones de empleado y sucursal en onModel
        if( 
            validator.isNumeric(variable.no_personas  ? variable.no_personas.toString() : '') &&
